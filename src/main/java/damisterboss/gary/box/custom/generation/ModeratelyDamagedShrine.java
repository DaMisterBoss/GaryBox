...
public class ModeratelyDamagedShrine extends StructureFeature<StructurePoolFeatureConfig> {

    public ModeratelyDamagedShrine(Codec<StructurePoolFeatureConfig> codec) {
        super(codec, ModeratelyDamagedShrine::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!ModeratelyDamagedShrine.isFeatureChunk(context)) {
        ...
        StructurePoolFeatureConfig newConfig = new StructurePoolFeatureConfig(
                ...
                () -> context.registryManager().get(Registry.STRUCTURE_POOL_KEY)
                        .get(new Identifier("garybox", "moderately_damaged_shrine/start_pool")),
        ...
        Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> structurePiecesGenerator =
            StructurePoolBasedGenerator.generate(newContext, PoolStructurePiece::new, blockpos.down(3), false, true);
