...
public class GaryFoodComponents {
    ...
    public static final FoodComponent GARY_SAUCE = (new FoodComponent.Builder()).hunger(1).saturationModifier(0.1f).statusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, 60, 0), 1).build();
