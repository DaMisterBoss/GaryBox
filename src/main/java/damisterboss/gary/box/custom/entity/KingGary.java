...
public class KingGary extends PathAwareEntity {

    public KingGary(EntityType<? extends PathAwareEntity> entityType, World world) {
    ...
    public ActionResult interactMob(PlayerEntity player, Hand hand) {
        ...
        if (itemStack.getItem() == Items.SHEARS) {
            ...
            ItemEntity itemEntity = new ItemEntity(this.world, this.getX(), this.getY(), this.getZ(), new ItemStack(GaryBox.CROWN, 1));
